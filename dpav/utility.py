...
def font_draw_8x8_character(vb: VBuffer, character: str, x: int, y: int, foreColor: int, backColor: int, fontROM: list[int] ) -> bool:
    ...
    targetCharacter = fontROM[ord(character[0])]
...
def font_draw_8x8_string(vb: VBuffer, string: str, x: int, y: int, foreColor: int, backColor: int, fontROM: list[int] ) -> bool:
    ...
    for character in string:
        font_draw_8x8_character(vb, character, x + currentCharacterX, y, foreColor, backColor, fontROM)
        currentCharacterX += 8
